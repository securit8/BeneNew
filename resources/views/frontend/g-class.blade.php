...
<div class="vehicle-specifics-outer">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('front/images/gclass/1.jpg')}}" class="" alt="...">
    </div>

    <div class="carousel-item">
      <img src="{{asset('front/images/gclass/2.jpg')}}" class="" alt="...">
    </div>

    <div class="carousel-item">
      <img src="{{asset('front/images/gclass/3.jpg')}}" class="" alt="...">
    </div>

    <div class="carousel-item">
      <img src="{{asset('front/images/gclass/4.jpg')}}" class="" alt="...">
    </div>
