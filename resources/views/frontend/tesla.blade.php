...
<div class="vehicle-specifics-outer">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('front/images/tesla/2.jpg')}}" class="" alt="...">
    </div>


    <div class="carousel-item">
      <img src="{{asset('front/images/tesla/1.jpg')}}" class="" alt="...">
    </div>

    <div class="carousel-item">
      <img src="{{asset('front/images/tesla/4.jpg')}}" class="" alt="...">
    </div>

    <div class="carousel-item">
      <img src="{{asset('front/images/tesla/6.jpg')}}" class="" alt="...">
    </div>
                ...
                <div class="vehicle-spesific-specs" id="arrow-down">
                  ...
                  <div class="spec-sheet-lines" id="spec-sheet">
                      ...
                      <div class="sheet-line-2">
                        ...
                        <p class="sheet-part-2">Model 3</p>
                      </div>
                      ...
                      <div class="sheet-line-7">
                        ...
                        <p class="sheet-part-2">@lang('front.fleet-electric-gas') </p>
                      </div>
