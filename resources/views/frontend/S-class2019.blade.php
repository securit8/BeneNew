...
<div class="vehicle-specifics-outer">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('front/images/merc222/1.jpg')}}" class="" alt="...">
    </div>


    <div class="carousel-item">
      <img src="{{asset('front/images/merc222/2.jpg')}}" class="" alt="...">
    </div>


    <div class="carousel-item">
      <img src="{{asset('front/images/merc222/3.jpg')}}" class="" alt="...">
    </div>
    <div class="carousel-item">
      <img src="{{asset('front/images/merc222/4.jpg')}}" class="" alt="...">
    </div>
                ...
                <div class="vehicle-spesific-specs" id="arrow-down">
                  ...
                  <div class="spec-sheet-lines" id="spec-sheet">
                      ...
                      <div class="sheet-line-10">
                        ...
                        <p class="sheet-part-2">2/3 @lang('front.fleet-large')</p>
                      </div>
