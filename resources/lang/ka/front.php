...
return [
  ...
  'bus' => 'ავტობუსი',
  'coupe' => 'კუპე',
  'footer-text' => 'მეტი ინფორმაციის მისაღებად და თქვენი მოსაზრებების გასაზიარებლად ეწვიეთ ჩვენს სოციალურ პლატფორმებს.',
...
'motors-text-2' => 'მომსახურების პაკეტი მოიცავს:<br><br>
                    შერჩეული ავტომობილის ტექნიკურ შემოწმებას (ნებისმიერ ქვეყანაში ჩვენი
                    სპეციალისტის მიერ);<br>
                    ავტომობილის შემოწმების ფოტო და ვიდეო მასალით დასაბუთებას;<br>
                    ყველა საჭირო საექსპორტო დოკუმენტაციის მომზადებასა და ადგილზე
                    მიწოდებას;<br>
                    ავტომობილის ტრანსპორტირების დაზღვევას;<br>
                    ავტომობილის უსაფრთხო და სწრაფ ტრანსპორტირებას;<br>
                    ავტომობილის გამართულად მუშაობის ერთ წლიან გარანტიას',
...
'mersedes-business-week' => 'მერსედესის ბიზნეს კვირეული',
'mersedes-event' => 'მერსედეს ბენზის ღონისძიება',
'moiare' => 'მოიარე',
];
 ?>
