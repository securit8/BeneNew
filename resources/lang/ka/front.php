...
'partners-text' => 'ბენე ექსკლუზივი, როგორც სატრანსპორტო დარგის ლიდერი და<br>
                    ...
                    სახელმწიფო თუ კერძო სექტორის სხვადასხვა დარგში მოღვაწე კომპანიებთან.<br>
                    ბენე ექსკლუზივის განვითარებასთან ერთად იზრდება ჩვენი პარტნიორების<br>
                    ბაზაც, რომელიც ამჟამად წარმოდგენილია:<br><br>
                    საქართველოს პრეზიდენტის ადმინისტრაცია;<br>
                    საქართველოს პარლამენტი;<br>
                    საქართველოს საგარეო სამინისტრო;<br>
                    საქართველოს კულტურის სამინისტრო (ფესტივალები, კონცერტები და
                    ა.შ.);<br>
                    სპორტის ფედერაციები (ფეხბურთი, კალათბურთი, კარატე და ა.შ.);<br>
                    ივენთ ჰოლი;<br>
                    ტურისტული კომპანიები;<br>
                    საერთაშორისო ქსელის სასტუმროები:<br>
                    Marriott<br>
                    Biltmore<br>
                    Paragraph<br>
                    Adjara Group<br>
                    Sheraton და სხვა<br>
                    მსხვილი და საშუალო საერთაშორისო დაადგილობრივი საწარმოები.',
