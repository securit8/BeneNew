...
'vehicles' => 'VEHICLES',
 ...
 'about-us-text-2' => 'შემდგომ წლებში ჩვენ გავაფართოვეთ საქმიანობის არეალი და განვახორციელეთ ინოვაციური პროექტები: დავაარსეთ და ჩავატარეთ რამდენიმე ბინზეს ღონისძიება, დავაფუძნეთ ბენე აკადემია და ჩამოვაყალიბეთ ბენე მოტორსი - უცხოეთიდან ექსკლუზიური ავტომობილების მიწოდება ხარისხის, ტრანსპორტირებისა და მიწოდების ვადების გარანტიით.<br>
  ...
  // academy page
'academy-part-1' => 'ახალი მიმართულება ბენე აკადემია 2021 წელს ამუშავდა. მისი მიზანია ხელი შეუწყოს ქვეყანაში სტუმარ-მასპინძლობის სხვადასხვა სფეროს წარმომადგენლების კვალიფიკაციის ამაღლებას და მათ გადამზადებას. ჩვენ ასევე ხელს ვუწყობთ წარჩინებულ კურსდამთავრებულებს დასაქმებაში როგორც ჩვენს კომპონიაში ასევე სხვა წამყვან კომპანიებში.',
